...
namespace TcgEngine.Gameplay
{
    ...
    public sealed class GameRuntimeContext
    {
        ...
        public SecretSystem SecretSystem;
        ...
        public GameRuntimeContext(GameLogic logic, Game game, bool isAiPredict)
        {
            ...
            SecretSystem = new SecretSystem(this);
        }
    ...
    public class GameLogic
    {
       ...
       //---- 秘密卡相关 ------------
        ...
        {
            return runtime.SecretSystem.TriggerPlayerSecrets(player, trigger_type);
        }

        // 最多触发一张
        public virtual bool TriggerSecrets(AbilityTrigger trigger_type, Card triggerer)
        {
            return runtime.SecretSystem.TriggerSecrets(trigger_type, triggerer);
        }
